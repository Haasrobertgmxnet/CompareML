...
> metaDataArray = {
	.data = std::tuple(
		Helper::FFNStructureData<2>{Helper::MLCase::Iris, "iris.csv",4,{6,4},3, 0.0},
		Helper::FFNStructureData<3>{Helper::MLCase::Wine, "wine.csv",13,{16,9,6},3, 0.0},
		Helper::FFNStructureData<4>{Helper::MLCase::Ionosphere, "ionosphere.csv",34,{40, 28, 16, 8},2, 0.0},
		Helper::FFNStructureData<4>{Helper::MLCase::Cancer, "cancer.csv",30,{36, 24, 12, 6},2, 0.0},
		Helper::FFNStructureData<2>{Helper::MLCase::Diabetes, "diabetes.csv",8,{12, 6},2, 0.0}
